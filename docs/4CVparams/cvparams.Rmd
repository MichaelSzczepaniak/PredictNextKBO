...
library(dplyr)
f1train <- read.csv('https://www.dropbox.com/s/524dgfw0ej2d4m3/cv_blogs_fold1_itrs500.csv?dl=1')
f1train <- arrange(f1train, desc(acc))
fold_train_best <- c(f1train$acc[1])
fold_train_best_count <- c(nrow(filter(f1train, acc==fold_train_best[1])))
...
-----|-----------:|--------------------:|--------------:|-------------:
1    | [fold_1blogs_predict.txt](https://www.dropbox.com/s/ow47mbpakiuhk0l/fold_1blogs_predict.txt?dl=1) | [cv_blogs_fold1_itrs500.csv](https://www.dropbox.com/s/524dgfw0ej2d4m3/cv_blogs_fold1_itrs500.csv?dl=1) | `r fold_train_best[1]` | `r fold_train_best_count[1]`
