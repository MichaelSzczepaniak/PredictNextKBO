...
The **getAlphaTrigram** function shown below implements equation 15. above to compute the trigram discount.  Here we us it to compute the trigram discount for $q_{BO}(house\:|\:sell,\:the)$:
