...
obsTrigrams <- calc.qBO.trigramsA(bigramPrefix='sell_the', trigrams=trigrams)
obsTrigrams
```

#### Step 3. Calculate Probabilities of Words Completing Unobserved Trigrams

This is most complex step as it involves backing off to the bigram level.  Here is breakdown of the sub-steps in these calculations:
