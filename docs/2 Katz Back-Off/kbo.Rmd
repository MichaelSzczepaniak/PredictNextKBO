...
0. Organize the data needed to use the equations defined above:
  + Create tables of unigram, bigram, and trigram counts.
  + Select the values for discounts at the bigram and trigram levels: $\gamma_2$ and $\gamma_3$.
...
The steps described in the previous section as straightforward, but step 3. deserves futher explaination.  Each $q_{BO}$ term in equation 17. needs to be calculated using either equation 10. or equation 16. depending on whether the bigram $(w_{i-1}, w_i)$ is observed or unobserved.  If this bigram is observed, equation 10. should be used.  If it is unobserved, equation 16. should be used.
