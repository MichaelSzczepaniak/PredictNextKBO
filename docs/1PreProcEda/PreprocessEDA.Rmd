...
This objective was addressed concurrently while working on each of the prior objectives by making sure that each function was properly documented, and that all code was made available.  All pre-processing code (Objective #2) is provided in the **Appendix** section of this R Markdown document.
...
#### Sentence Parsing
The **parseSentsToFile** function was used to parse the data into a single sentence per line and then write the resulting files out for later processing.
