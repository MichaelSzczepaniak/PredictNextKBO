...
2. Pre-Profanity Filtering - This step converted the text to lower case, replaced chars similar to single quotes with simple ascii single quote chars, and then removed anything not a word character or character needed to create one of the profanity words/phrases in the profanity list.
3. Profanity Removal - This step removed the profanity from the text.
4. Post-Profanity Filtering - This step removed urls and other non-essential characters.
...
If future versions of NP++ do not behave the same way as v6.9.2, [this version can be downloaded here](https://www.dropbox.com/s/t7l03782ngh84dg/npp.6.9.2.Installer.exe?dl=1)

#### Pre-Profanity Filtering
