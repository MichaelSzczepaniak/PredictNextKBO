...
runPreProfFilter <- function(dataDir=ddir,
    ...
    cat("START pre-profanity filtering", as.character(Sys.time()), "\n")
    ...
    preProfFiltered <- preProfFilter(samp=fileLines, is.news=is.news)
    writeLines(preProfFiltered, outPath)
    cat("FINISH pre-profanity filtering", as.character(Sys.time()), "\n")
}
```
